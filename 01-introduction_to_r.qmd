...
format: 
    ...
    #     center-title-slide: false
    html:
        output-file: 00-introduction_to_r-page.html
        code-tools:
            source: repo
    ipynb:
        jupyter:
...
<iframe src="https://mastodon.social/@kjhealy/111930405065848105/embed" class="mastodon-embed" style="max-width: 100%; border: 0" width="800" allowfullscreen="allowfullscreen"></iframe><script src="https://mastodon.social/embed.js" async="async"></script>
